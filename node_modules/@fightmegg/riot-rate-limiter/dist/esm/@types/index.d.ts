...
export declare const METHODS: {
    ...
    readonly CLASH: {
        readonly GET_PLAYERS_BY_PUUID: "/lol/clash/v1/players/by-puuid/:puuid";
    ...
    readonly MATCH: {
        readonly GET_IDS_BY_TOURNAMENT_CODE: "/lol/match/v4/matches/by-tournament-code/:tournamentCode/ids";
        readonly GET_MATCH_BY_ID: "/lol/match/v4/matches/:matchId";
        readonly GET_MATCH_BY_ID_AND_TOURNAMENT_CODE: "/lol/match/v4/matches/:matchId/by-tournament-code/:tournamentCode";
        readonly GET_MATCHLIST_BY_ACCOUNT: "/lol/match/v4/matchlists/by-account/:accountId";
        readonly GET_TIMELINE_BY_MATCH_ID: "/lol/match/v4/timelines/by-match/:matchId";
    };
    readonly MATCH_V5: {
    ...
    readonly SPECTATOR: {
        readonly GET_GAME_BY_SUMMONER_ID: "/lol/spectator/v4/active-games/by-summoner/:summonerId";
        readonly GET_FEATURED_GAMES: "/lol/spectator/v4/featured-games";
    };
    readonly SUMMONER: {
        ...
        readonly GET_BY_SUMMONER_NAME: "/lol/summoner/v4/summoners/by-name/:summonerName";
    ...
    readonly TFT_SUMMONER: {
        ...
        readonly GET_BY_SUMMONER_NAME: "/tft/summoner/v1/summoners/by-name/:summonerName";
    ...
    readonly THIRD_PARTY_CODE: {
        readonly GET_BY_SUMMONER_ID: "/lol/platform/v4/third-party-code/by-summoner/:summonerId";
    };
    readonly TOURNAMENT_STUB: {
        readonly POST_CREATE_CODES: "/lol/tournament-stub/v4/codes";
        readonly GET_LOBBY_EVENTS_BY_TOURNAMENT_CODE: "/lol/tournament-stub/v4/lobby-events/by-code/:tournamentCode";
        readonly POST_CREATE_PROVIDER: "/lol/tournament-stub/v4/providers";
        readonly POST_CREATE_TOURNAMENT: "/lol/tournament-stub/v4/tournaments";
    };
    ...
    readonly TOURNAMENT: {
        readonly POST_CREATE_CODES: "/lol/tournament/v4/codes";
        readonly GET_TOURNAMENT_BY_CODE: "/lol/tournament/v4/codes/:tournamentCode";
        readonly PUT_TOURNAMENT_CODE: "/lol/tournament/v4/codes/:tournamentCode";
        readonly GET_LOBBY_EVENTS_BY_TOURNAMENT_CODE: "/lol/tournament/v4/lobby-events/by-code/:tournamentCode";
        readonly POST_CREATE_PROVIDER: "/lol/tournament/v4/providers";
        readonly POST_CREATE_TOURNAMENT: "/lol/tournament/v4/tournaments";
    };
